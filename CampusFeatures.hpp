...
class busStops : public MapObjects {
	...
	string getServices();
  	...
  	busStops();
	busStops(const string loc, const string addr, const string name, const string type, const string services);
...
class bikeRacks : public MapObjects {
	public:
  	bikeRacks();
	bikeRacks(const string loc, const string addr, const string name);
};
...
class ChargingStations : public MapObjects {
	public:
  	ChargingStations();
	ChargingStations(const string loc, const string addr, const string name);
};
